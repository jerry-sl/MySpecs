...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://git.oschina.net/idbati/TJSchoolKit.git", :tag => s.version }
  ...
  s.source_files  = "TJSchoolKit/TJSchoolKit.h"
  ...
  s.subspec 'TJSchoolKitCore' do |base|
    ...
    base.source_files = 'TJSchoolKit/TJClient.{h,m}','TJSchoolKit/TJResponse.{h,m}','TJSchoolKit/TJObject.{h,m}','TJSchoolKit/TJServer.{h,m}',
    'TJSchoolKit/TJClient+Private.h','TJSchoolKit/TJServer+Private.h','TJSchoolKit/TJObject+Private.h'
    base.public_header_files = 'TJSchoolKit/TJClient.h','TJSchoolKit/TJResponse.h','TJSchoolKit/TJObject.h','TJSchoolKit/TJServer.h'
  end

  s.subspec 'Login' do |login| 
    login.dependency 'TJSchoolKit/TJSchoolKitCore'
    login.source_files = 'TJSchoolKit/TJClient+SignIn.{h,m}'
    login.public_header_files = 'TJSchoolKit/TJClient+SignIn.h'
  end
